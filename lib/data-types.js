 ...
 * @description Midi meta channel prefix event
 * @param {object} params - properties to set
...
/**
 * @class MidiMetaMidiPortEvent
 * @description Midi meta MIDI port event
 * @param {object} params - properties to set
 * @param {number} params.port - port (0-127)
 * @return MidiMetaMidiPortEvent
 */
const MidiMetaMidiPortEvent = createDataType(function (params) {
	this.port  = params.port;

	this.subtype = 'midi_port';
}, MidiMetaEvent);
...
module.exports = {
	...
	MidiMetaMidiPortEvent: MidiMetaMidiPortEvent,
